...
--save_to1=<save_to1>            This is the file path for the model performance
--save_to2=<save_to2>            This is the file path for the important features
"""
...
def main(file_path1, file_path2, file_path3, save_to1, save_to2):
...
if __name__ == "__main__":
    main(opt["--file_path1"], opt["--file_path2"], opt["--file_path3"], opt["--save_to1"], opt["--save_to2"])
