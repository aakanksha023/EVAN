...
- **Rough draft**
- **remove this completely?**(The digital revolution has made data ubiquitous in problem-solving, from route-finding to planning for human capital.) 

Accessible public data repositories (e.g. Open Vancouver website) mean that in part, data science strategies can increasingly be used to tackle complex public policy concerns. In this project, our goal is to understand the evolution of business climate across Vancouver's diverse neighbourhoods. We will 
